...
!  real*8,  intent(in) :: missing_real8
!  real*8,  intent(in), optional :: missing_real8
...
!  if(present(missing_real8)) then
!      status = nf90_put_att(ncid, varid, "_FillValue", missing_real8)
!      if(status /= nf90_noerr) then
!         write(unit=0, fmt='(a, f12.2)') "Problem to write attribute missing_real8: ", missing_real8
