...
class PlotVariable():
 ...
 #-----------------------------------------------------------------------------------------
  def process(self, flnm=None, varname = 'sfc_net_lw_clr_daily'):
...
if __name__== '__main__':
 ...
 #varname = 'sfc_net_sw_all_daily'
  varname = 'sfc_net_lw_all_daily'
  pv.process(flnm=filename, varname=varname)
