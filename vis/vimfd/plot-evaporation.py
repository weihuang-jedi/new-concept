...
def plotit(x, y, z, title, imgname):
 ...
 #cblevs = np.arange(-100.0, 110.0, 10.0)
  ...
  clevs = np.arange(0.0, 1510.0, 10.0)
  cblevs = np.arange(0.0, 1600.0, 100.0)
...
class PlotVariable():
 ...
 #-----------------------------------------------------------------------------------------
  def process(self, flnm=None, imgname='GFS Evaporation'):
