...
#rm -f *.png
 ...
 do
   ...
   python plotpvar.py \
     ...
     --flnm=monthly_mean_ERA5_VIMFD_${hour}Z_Dec_2021.nc &

   python plotdiff.py \
     --datadir=/work2/noaa/gsienkf/weihuang/era5/vis/vimfd/data \
     --base=monthly_mean_ERA5_VIMFD_${base}Z_Dec_2021.nc \
     --flnm=monthly_mean_ERA5_VIMFD_${hour}Z_Dec_2021.nc \
     --imgname=monthly_mean_ERA5_VIMFD_${hour}Z-${base}Z_Dec_2021 &
 done
