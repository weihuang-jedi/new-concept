...
class GeneratePlot():
  ...
  def setup_default(self):
   #cmapname = coolwarm, bwr, rainbow, jet, seismic, nipy_spectral
    ...
    self.clevs = np.arange(-2.0, 2.01, 0.01)
...
class PlotVariable():
 ...
 #-----------------------------------------------------------------------------------------
  def process(self, flnm=None, imgname='Moisture_Flux_Divergence'):
   ...
   #pvar = val[:, :, nlon]
    ...
    zp = z[16:]
    vp = 100.0*pvar[16:, :]
    title = 'Moisture Flux Divergence ERA5, Dec 2021'
...
if __name__== '__main__':
  ...
  imgname = 'Moisture_Flux_Divergence'
