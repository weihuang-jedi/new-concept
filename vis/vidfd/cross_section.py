...
data = xr.open_dataset(get_test_data('/work2/noaa/gsienkf/weihuang/era5/data/monthly-mean-pressure-level.nc', False))
...
rh_contour = ax.contourf(cross['longitude'], cross['level'], cross['q'],
