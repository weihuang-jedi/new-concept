...
#rm -f *.png
 ...
 do
   ...
   python plotpvar.py \
     ...
     --flnm=monthly_mean_gfs_vidfd_${hour}Z_dec_2021.nc &

   python plotdiff.py \
     --datadir=/work2/noaa/gsienkf/weihuang/gfs/vis/vidfd/data \
     --base=monthly_mean_gfs_vidfd_${base}Z_dec_2021.nc \
     --flnm=monthly_mean_gfs_vidfd_${hour}Z_dec_2021.nc \
     --imgname=monthly_mean_gfs_vidfd_${hour}Z-${base}Z_Dec_2021 &
 done
