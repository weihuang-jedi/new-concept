...
if __name__== '__main__':
  ...
  datafile = '%s/state_cate_20220116_0000.nc' %(datadir)
...
#-----------------------------------------------------------------------------------------
  ...
  for i in range(0, 720, 60):
    ...
    cscate = cate[:,:,i] + 0.5
    if(lon < 0):
      title = 'gfs Atmospheric Systems Catalog 2020116001 at Lon %dW' %(-lon)
      imagename = 'gfs_2022011600_at_lon_%dW.png' %(-lon)
    else:
      title = 'gfs Atmospheric Systems Catalog 2022011600 at Lon %dE' %(lon)
      imagename = 'gfs_dec2022011600_at_lon_%dE.png' %(lon)
    print('title = ', title)
