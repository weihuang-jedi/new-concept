 ...
 do
   ...
   do
     ...
     then
       ...
       echo ncl compute_grad_catalog.ncl \
          "diri=\"${datadir}\"" \
          "fili=\"${ifile}\"" \
          "filo=\"${ofile}\""
     fi
